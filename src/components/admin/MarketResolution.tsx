...
export function MarketResolution() {
  ...
  const handleDelete = async (market: Market) => {
    if (!window.confirm("Er du sikker på at du vil slette dette bettet?"))
      return;
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNotes({ ...notes, [market.id]: e.target.value })
                  }
                ...
                <button
                  ...
                  disabled={
                    !selectedOutcome[market.id] || resolvingId === market.id
                  }
